...
const (
	...
	PACKET_SOCKS5_RULESET_DENIED_ACK           = 0x18
	PACKET_SOCKS5_NETWORK_UNREACHABLE          = 0x19
	PACKET_SOCKS5_NETWORK_UNREACHABLE_ACK      = 0x1A
	PACKET_SOCKS5_HOST_UNREACHABLE             = 0x1B
	PACKET_SOCKS5_HOST_UNREACHABLE_ACK         = 0x1C
	PACKET_SOCKS5_CONNECTION_REFUSED           = 0x1D
	PACKET_SOCKS5_CONNECTION_REFUSED_ACK       = 0x1E
	PACKET_SOCKS5_TTL_EXPIRED                  = 0x1F
	PACKET_SOCKS5_TTL_EXPIRED_ACK              = 0x20
	PACKET_SOCKS5_COMMAND_UNSUPPORTED          = 0x21
	PACKET_SOCKS5_COMMAND_UNSUPPORTED_ACK      = 0x22
	PACKET_SOCKS5_ADDRESS_TYPE_UNSUPPORTED     = 0x23
	PACKET_SOCKS5_ADDRESS_TYPE_UNSUPPORTED_ACK = 0x24
	PACKET_SOCKS5_AUTH_FAILED                  = 0x25
